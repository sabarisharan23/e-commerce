...
export function AccountPaymentMethods() {
  return (
    <div className="space-y-7">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <div className="flex flex-wrap items-center gap-3">
                      <h3 className="text-[1.6rem] font-semibold tracking-tight text-[#1a2540]">
                    ...
                    <p className="mt-1 text-base text-[#6a7992]">
        ...
        <div className="grid gap-6 xl:grid-cols-2">
          {alternatePaymentMethods.map((method) => (
            ...
            >
              ...
              <h3 className="mt-5 text-[1.7rem] font-semibold tracking-tight text-[#1a2540]">
                {method.title}
              </h3>
              <p className="mt-2 text-base leading-7 text-[#6a7992]">
                {method.description}
              </p>
      ...
      <div className="border-t border-[#dfe6ef] pt-6 text-center text-base text-[#64738c]">
        Need help with payments?{" "}
        <button type="button" className="font-semibold text-[#487540]">
          Visit Support Center
        </button>{" "}
        or{" "}
        <button type="button" className="font-semibold text-[#2f8e44]">
          Contact us
        </button>
      </div>
    </div>
